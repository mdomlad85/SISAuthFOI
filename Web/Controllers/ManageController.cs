    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetTwoFactorSuccess ? "2F davatelj je postavljen."
        ...
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.RemoveLoginSuccess ? "Vanjski servis za prijavu je uklonjen."
                : message == ManageMessageId.Error ? "Došlo je do pogreške."
                : "";
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            if (user == null)
        ...
        {
            // Povezivanje vanjskog logina i zadavanje callback url-a
